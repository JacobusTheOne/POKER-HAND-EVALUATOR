...
namespace MY_POKER_PROJECT
{
    class Program
    {
        ...
        {
            // initialize board
             string board = "kd kh qh 3h qc";
    ///         // Create a hand with AKs plus board
            Hand h1 = new Hand("kc ks", board);
    ...
    ///         // Find stronger hand and print results
             if (h1 > h2)
             {
                 Console.WriteLine("{0} GREATER THAN {1}", h1.Description, h2.Description);
                 Console.WriteLine("The hand rank of h1 is: {0}",h1.HandValue);
                 Console.WriteLine("The hand rank of h2 is: {0}",h2.HandValue);
            }
             else
            {
